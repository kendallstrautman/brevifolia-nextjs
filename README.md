...
Brevifolia is minimalist blog starter to get you going using [Next.js](https://nextjs.org/). Check out the demo [here](https://brevifolia-next-forestry.netlify.com).
...
```bash
#clone the repo
git clone git@github.com:kendallstrautman/brevifolia-next.git
...
[![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/kendallstrautman/brevifolia-next)
